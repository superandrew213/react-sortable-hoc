!(function(e, t) {
    ...
    return (
      (t = e = (function(e) {
        function t(e) {
          ...
          return (
            h(this, t),
            (m = b(this, w(t).call(this, e))),
            O(v(v(m)), 'handleStart', function(e) {
              var t = m.props,
                n = t.distance,
                o = t.shouldCancelStart;
              if (2 !== e.button && !o(e)) {
                (m._touched = !0), (m._pos = N(e));
                var r,
                ...
                if (
                  ...
                  var a = m.props.useDragHandle,
                    s = i.sortableInfo,
                    l = s.index,
                    c = s.collection;
                  if (
                    a &&
                    !A(e.target, function(e) {
                      return null != e.sortableHandle;
                    })
                  )
                    return;
                  (m.manager.active = {index: l, collection: c}),
            ...
            O(v(v(m)), 'nodeIsChild', function(e) {
              return e.sortableInfo.manager === m.manager;
            }),
            O(v(v(m)), 'handleMove', function(e) {
              var t = m.props,
                n = t.distance,
                o = t.pressThreshold;
              if (
                ...
                var r = N(e),
                  i = {x: m._pos.x - r.x, y: m._pos.y - r.y},
                  a = Math.abs(i.x) + Math.abs(i.y);
                (m.delta = i),
                  n || (o && !(o && o <= a))
                    ? n && n <= a && m.manager.isActive() && m.handlePress(e)
                    : (clearTimeout(m.cancelTimer),
                      (m.cancelTimer = setTimeout(m.cancel, 0)));
              }
            }),
            O(v(v(m)), 'handleEnd', function() {
              (m._touched = !1), m.cancel();
            }),
            O(v(v(m)), 'cancel', function() {
              var e = m.props.distance;
              m.state.sorting ||
                (e || clearTimeout(m.pressTimer), (m.manager.active = null));
            }),
            O(v(v(m)), 'handlePress', function(v) {
              try {
                    ...
                    if (r) {
                      var e = function() {
                          var e,
                            ...
                            o = m.container.getBoundingClientRect(),
                            r = c({index: g, node: p, collection: y});
                          (m.node = p),
                            (m.margin = n),
                            (m.width = r.width),
                            (m.height = r.height),
                            (m.marginOffset = {
                              x: m.margin.left + m.margin.right,
                              y: Math.max(m.margin.top, m.margin.bottom),
                            }),
                            (m.boundingClientRect = p.getBoundingClientRect()),
                            (m.containerBoundingRect = o),
                            (m.index = g),
                            (m.newIndex = g),
                            (m.axis = {
                              x: 0 <= l.indexOf('x'),
                            ...
                            (m.offsetEdge = _(p, m.container)),
                            (m.initialOffset = N(v)),
                            (m.initialScroll = {
                              top: m.container.scrollTop,
                              left: m.container.scrollLeft,
                            }),
                          ...
                          var i,
                            a = p.querySelectorAll('input, textarea, select'),
                            s = p.cloneNode(!0);
                          (x(
                            s.querySelectorAll('input, textarea, select'),
                          ).forEach(function(e, t) {
                            'file' !== e.type && a[g] && (e.value = a[t].value);
                          }),
                          (m.helper = m.helperContainer.appendChild(s)),
                          (m.helper.style.position = 'fixed'),
                          (m.helper.style.top = ''.concat(
                            m.boundingClientRect.top - n.top,
                            'px',
                          )),
                          (m.helper.style.left = ''.concat(
                            m.boundingClientRect.left - n.left,
                            'px',
                          )),
                          (m.helper.style.width = ''.concat(m.width, 'px')),
                          (m.helper.style.height = ''.concat(m.height, 'px')),
                          (m.helper.style.boxSizing = 'border-box'),
                          (m.helper.style.pointerEvents = 'none'),
                          f &&
                            (((m.sortableGhost = p).style.visibility =
                              'hidden'),
                            (p.style.opacity = 0)),
                          (m.minTranslate = {}),
                          (m.maxTranslate = {}),
                          ...
                          m.axis.y &&
                            ...
                            (m.maxTranslate.y =
                              ...
                              m.height / 2)),
                          u) &&
                            (i = m.helper.classList).add.apply(
                              i,
                              x(u.split(' ')),
                            );
                          (m.listenerNode = v.touches ? p : m.contentWindow),
                            ...
                            m.setState({sorting: !0, sortingIndex: g}),
                            h && h({node: p, index: g, collection: y}, v);
                        },
                        t = m.props,
                        l = t.axis,
                            ...
                            var e = (function(e, t) {
                              ...
                              function() {
                                return Promise.resolve(
                                  n({node: p, index: g, collection: y}, v),
                                ).then(function() {});
                              },
                              function(e, t) {
                                if (
            ...
            O(v(v(m)), 'handleSortMove', function(e) {
            ...
            O(v(v(m)), 'handleSortEnd', function(e) {
              var t = m.props,
                n = t.hideSortableGhost,
                o = t.onSortEnd,
                r = m.manager.active.collection;
              m.listenerNode &&
                (D.move.forEach(function(e) {
                ...
                D.end.forEach(function(e) {
                  return m.listenerNode.removeEventListener(e, m.handleSortEnd);
                })),
                m.helper.parentNode.removeChild(m.helper),
                n &&
                  m.sortableGhost &&
                  ((m.sortableGhost.style.visibility = ''),
                  (m.sortableGhost.style.opacity = ''));
              for (var i = m.manager.refs[r], a = 0, s = i.length; a < s; a++) {
                var l = i[a],
                  c = l.node;
                (l.edgeOffset = null),
              ...
              clearInterval(m.autoscrollInterval),
                (m.autoscrollInterval = null),
                (m.manager.active = null),
                m.setState({sorting: !1, sortingIndex: null}),
                'function' == typeof o &&
                  o(
                    {oldIndex: m.index, newIndex: m.newIndex, collection: r},
                    e,
                  ),
                (m._touched = !1);
            }),
            O(v(v(m)), 'autoscroll', function() {
              if (!m.props.disableAutoscroll) {
                var e = m.translate,
                  n = {x: 0, y: 0},
                  o = {x: 1, y: 1},
                  t = 10,
                  r = 10;
                e.y >= m.maxTranslate.y - m.height / 2
                  ? ((n.y = 1),
                    (o.y =
                      r *
                      Math.abs(
                        (m.maxTranslate.y - m.height / 2 - e.y) / m.height,
                      )))
                  : e.x >= m.maxTranslate.x - m.width / 2
                  ? ((n.x = 1),
                    (o.x =
                      t *
                      Math.abs(
                        (m.maxTranslate.x - m.width / 2 - e.x) / m.width,
                      )))
                  : e.y <= m.minTranslate.y + m.height / 2
                  ? ((n.y = -1),
                    (o.y =
                      r *
                      Math.abs(
                        (e.y - m.height / 2 - m.minTranslate.y) / m.height,
                      )))
                  : e.x <= m.minTranslate.x + m.width / 2 &&
                    ((n.x = -1),
                    (o.x =
                      t *
                      Math.abs(
                        (e.x - m.width / 2 - m.minTranslate.x) / m.width,
                      ))),
                  m.autoscrollInterval &&
                    (clearInterval(m.autoscrollInterval),
                    (m.autoscrollInterval = null),
                    (m.isAutoScrolling = !1)),
                  (0 === n.x && 0 === n.y) ||
                    (m.autoscrollInterval = setInterval(function() {
                      m.isAutoScrolling = !0;
                      var e = o.x * n.x,
                        t = o.y * n.y;
                      (m.scrollContainer.scrollTop += t),
            ...
            },
            {
              ...
              value: function() {
                ...
                var r = p(o, 2),
                  ...
                  a = r[1];
                return [
                  j({lockOffset: i, width: e, height: t}),
                  j({lockOffset: a, width: e, height: t}),
                ];
              },
            },
            {
              ...
              value: function() {
                ...
                for (var h = 0, d = r.length; h < d; h++) {
                  var p = r[h].node,
                    ...
                    b = {x: 0, y: 0},
                    w = r[h].edgeOffset;
                  w || ((w = _(p, this.container)), (r[h].edgeOffset = w));
                  var S = h < r.length - 1 && r[h + 1],
                    O = 0 < h && r[h - 1];
                  S &&
                    !S.edgeOffset &&
                    (S.edgeOffset = _(S.node, this.container)),
                    y !== this.index
                      ? (t &&
                          (p.style[
  ...
  function H(n) {
    ...
    return (
      (t = e = (function(e) {
        function t() {
          return h(this, t), b(this, w(t).apply(this, arguments));
        }
        return (
          S(t, e),
          y(t, [
